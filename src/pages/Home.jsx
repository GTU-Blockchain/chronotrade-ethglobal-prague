...
function Home() {
  return (
    <main className="min-h-screen bg-gradient-to-br via-blue-950 from-gray-800 to-gray-800 text-white flex flex-col items-center justify-center bg-[#141A1E]">
      <Navbar />
        ...
        <form>
          <div className="flex items-center justify-center space-x-4">
            <input
              ...
              className="p-2 rounded-2xl bg-gray-700 text-white focus:outline-none focus:ring-2 focus:ring-blue-500 w-2xl px-4 py-3"
            />
            <button
              type="submit"
              className="px-4 py-3 bg-blue-500 hover:bg-blue-600 rounded-xl text-white transition-colors"
            >
              Ask
            </button>
          </div>
      ...
      <section className="h-screen flex flex-col items-start w-5xl pt-10 mx-auto">
        <div className="flex flex-col items-start mb-4">
          ...
          <div className="flex flex-row items-start justify-center space-x-4 mt-4 w-full">
            <div className="text-center rounded-full bg-blue-950 py-2 px-4">
              Latest
            </div>
            <div className="text-center rounded-full bg-blue-950 py-2 px-4">
              Trending
